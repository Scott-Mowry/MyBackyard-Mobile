...
// Errors that doesn't display feedback messages
const kInvalidStatusCode403HttpExceptionMsg = 'IMAGE_INVALID_STATUS_CODE_403_ERROR';
const kPermissionRequestErrorKey = 'PERMISSION_REQUEST_ERROR';
const kLocalStorageInitErrorKey = 'LOCAL_STORAGE_INIT_ERROR';
const kConnectivityInitErrorKey = 'CONNECTIVITY_INIT_ERROR';
