...
class CustomMonthPickerDialog extends StatefulWidget {
  ...
  const CustomMonthPickerDialog({super.key, this.selectedMonth, this.onChanged, this.i});
    ...
    return Dialog(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(padding: EdgeInsets.symmetric(horizontal: 10.w), child: Divider()),
          SizedBox(height: 2.h),
          GridView.builder(
              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  child: MyText(
                    ...
                    clr: widget.selectedMonth == (index + 1) ? Colors.white : Colors.black,
                    size: 15,
                  ),
                ),
              );
